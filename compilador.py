...
if __name__ == "__main__":
    ...
    try:
        ...
        os._exit(0)
"""
    with open("lanzador_visor.py", "w", encoding="utf-8") as f:
        f.write(codigo)
    print("✅ Archivo puente (lanzador_visor.py) creado.")

def compilar():
    print("🚀 INICIANDO FASE 3: COMPILACIÓN A .EXE")
    crear_lanzador()
    
    # Definir separador de rutas según el SO (; en Windows, : en Unix)
    sep = ";" if os.name == "nt" else ":"
    
    # Comandos de PyInstaller con todas las dependencias críticas forzadas
    comando = [
        ...
        f"--add-data=visor_maestro_portable.py{sep}.",
    ...
    print("📦 Ejecutando PyInstaller... Esto puede tardar varios minutos (es normal).")
